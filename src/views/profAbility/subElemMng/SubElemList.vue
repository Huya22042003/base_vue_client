        ...
        <div class="box_inner">
          <div class="box_section">
            <div class="search_box col_3">
              <ul>
                <li>
                  <p>{{ t("02.elemList.laybal.profNm") }}</p>
                  <InputBase :id="'profNm'" v-model="abiSearch.profAbilityNm" />
                </li>
                <li>
                  <p>{{ t("02.elemList.laybal.subNm") }}</p>
                  <InputBase :id="'subNm'" v-model="abiSearch.subAbilityNm" />
                </li>
                <li>
                  <p>{{ t("02.elemList.laybal.stsNm") }}</p>
                  <RadiobuttonBase
      ...
      <div class="box dp_block">
        <div class="box_inner">
          <span class="note_custom"
            >※ 등록된 교수역량-하위역량으로 목록이 자동구성됩니다.</span
          >
          <GridComponentV2
            :rowData="rowData"
...
import { subElemList } from "@/stores/profChldAbility/profChldAbility.service";
import { ElemPageSearchDTO } from "@/stores/profAbility/profAbility.type";
...
export default defineComponent({
  ...
  data() {
    return {
      pageTitle: this.t("02.elemList.laybal.title"),
      breadcrumbItems: [
        { label: this.t("common.home"), link: "/" },
        {
          label: this.t("02.elemList.laybal.title"),
          link: SCREEN.subElemList.path,
        },
      ],
      picker1: new Date(),
      parentListObject: [],
      ...
      columnDefs: ref([
        {
          headerName: this.t("02.elemList.laybal.profNm"),
          field: "profAbiNm",
          flex: 3,
          cellStyle: {
            textAlign: "center",
        ...
        {
          headerName: this.t("02.elemList.laybal.subNm"),
          field: "subAbiNm",
          flex: 3,
          cellStyle: {
            color: "#2704FF",
        ...
        {
          headerName: this.t("02.elemList.laybal.stsNm"),
          field: "stsReg",
          flex: 2,
          cellStyle: {
            textAlign: "center",
        ...
        {
          headerName: this.t("02.elemList.laybal.regNm"),
          field: "regNm",
          flex: 2,
          cellStyle: {
            textAlign: "center",
        ...
        {
          headerName: this.t("02.elemList.laybal.regDate"),
          field: "regDate",
          flex: 2,
          cellStyle: {
            textAlign: "center",
  ...
  methods: {
    ...
    handleCustomClick(data: any) {
      this.$router.push({
        ...
        state: {
          chldSeq: data.profAbilityChldAbilitySeq,
        },
      });
    },
    reset() {
      this.abiSearch.profAbilityNm = "";
      this.abiSearch.subAbilityNm = "";
