...
export default defineComponent({
  ...
  data() {
    return {
      pageTitle: this.t("02.profAbilityChldList.pageTitle"),
      breadcrumbItems: [
        { label: this.t("common.home"), link: "/" },
        { label: this.t("02.profAbilityChd.menu"), link: "#" },
        {
          label: this.t("02.profAbilityChldList.pageTitle"),
      ...
      columnDefs: ref([
        {
          headerName: this.t("02.profAbilityChldList.rowNum"),
          field: "rowNum",
          flex: 1,
          cellStyle: {
            textAlign: "center",
        ...
        {
          headerName: this.t("02.profAbilityChldList.wisPriNm"),
          field: "wisePrideNm",
          flex: 4,
          cellStyle: {
            color: "#2704FF",
        ...
        {
          headerName: this.t("02.profAbilityChldList.stsNm"),
          field: "useYn",
          flex: 2,
          cellStyle: {
            textAlign: "center",
        ...
        {
          headerName: this.t("02.profAbilityChldList.regId"),
          field: "regId",
          flex: 2,
          cellStyle: {
            textAlign: "center",
        ...
        {
          headerName: this.t("02.profAbilityChldList.regDate"),
          field: "createDate",
          flex: 2,
          cellStyle: {
            textAlign: "center",
      ...
      coreChildList: [] as Array<ProfAbility>,
      abiSearch: {
        page: 1,
        size: 10,
        sort: "",
  ...
  methods: {
    async getList() {
      ...
      await this.chldStore.fetchProfList(this.abiSearch);
      if (this.chldStore.status && this.chldStore.status == SUCCSESS_STATUS) {
        this.coreChildList = this.chldStore.proList.data.content;

        this.totalRows = this.chldStore.proList.data.totalElements;
    ...
    handleCustomClick(data: any) {
      this.$router.push({
        ...
        state: {
          wisePrideSeq: data.wisePrideSeq,
        },
      });
    },
