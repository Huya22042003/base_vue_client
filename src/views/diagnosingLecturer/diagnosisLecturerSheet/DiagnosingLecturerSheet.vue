          ...
          <div class="search_box col_3">
            <ul>
              <li>
                <p class="ta_c">
                  {{
                    t("07.diagnosingLecturer.diagnosisSheet.titleSearch.name")
                  }}
                </p>
                <InputBase
                  :id="'surveyName'"
              ...
              <li>
                <p class="ta_c">
                  {{
                    t(
                      "07.diagnosingLecturer.diagnosisSheet.titleSearch.idTeacher"
                    )
                  }}
                </p>
                <InputBase
              ...
              <li>
                <p class="ta_c">
                  {{
                    t("07.diagnosingLecturer.diagnosisSheet.titleSearch.useYn")
                  }}
                </p>
                <SelectBoxBase
                  :id="'selectbox'"
            ...
            <ul>
              <li>
                <p class="ta_c">
                  {{
                    t("07.diagnosingLecturer.diagnosisSheet.titleSearch.status")
                  }}
                </p>
                <SelectBoxBase
                  :id="'selectbox'"
              ...
              <li>
                <p class="ta_c">
                  {{
                    t("07.diagnosingLecturer.diagnosisSheet.titleSearch.date")
                  }}
                </p>
            ...
            <template #button>
              <div class="search_btnarea">
                <button
                  ...
                  @click="register()"
                >
                  {{ t("07.diagnosingLecturer.button.register1") }}
                </button>
              </div>
            </template>
          </GridComponentV2>
...
import { SearchModel } from "../../../stores/profAbilityLecturer/profAbilityLecturerSurvey/proAbilitySurvey.type";
import { getAll } from "../../../stores/profAbilityLecturer/profAbilityLecturerSurvey/profAbilitySurvey.service";
import { format } from "date-fns";
import { getListCodeMng } from "../../../stores/common/codeMng/codeMng.service";
import GridComponentV2 from "@/components/common/grid/GridComponentV2.vue";

export default defineComponent({
  components: { Breadcrumb, LinkGridComponent, GridComponentV2 },
  setup() {
  ...
  data() {
    return {
      ...
      pageTitle: this.t("07.diagnosingLecturer.diagnosisSheet.pageTitle"),
      breadcrumbItems: [],
      columnDefs: [
        {
          headerName: this.t(
            "07.diagnosingLecturer.diagnosisSheet.table.rowNum"
          ),
          field: "rowNumber",
        ...
        {
          headerName: this.t("07.diagnosingLecturer.diagnosisSheet.table.name"),
          field: "surveyNm",
          cellStyle: {
            color: "#2704FF",
            display: "flex",
        ...
        {
          headerName: this.t(
            "07.diagnosingLecturer.diagnosisSheet.table.idTeacher"
          ),
          field: "regId",
          cellStyle: { textAlign: "center" },
          flex: 0.8,
        ...
        {
          headerName: this.t(
            "07.diagnosingLecturer.diagnosisSheet.table.useYn"
          ),
          field: "useYn",
          cellStyle: { textAlign: "center" },
          flex: 0.5,
        ...
        {
          headerName: this.t(
            "07.diagnosingLecturer.diagnosisSheet.table.status"
          ),
          field: "stsCd",
          cellStyle: { textAlign: "center" },
          flex: 0.6,
        ...
        {
          headerName: this.t("07.diagnosingLecturer.diagnosisSheet.table.date"),
          field: "regDate",
          cellStyle: { textAlign: "center" },
          flex: 0.7,
        },
