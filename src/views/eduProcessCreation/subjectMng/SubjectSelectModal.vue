<template>
  ...
  >
    <template #title>
      <strong>{{ t("eduProcessCreation.subjectMng.modal.title1") }}</strong>
    </template>
    <template #default>
          ...
          <ul>
            ...
            <li>
              <p class="ta_c">{{
                ...
                <InputBase v-model="dataSearch.acqCredit" />
            </li>
            <li>
              <p class="ta_c">{{
...
import { getAllVSbjtInfo } from "../../../stores/eduProcessCreation/subjectMng/subjectMng.service";
import { VSbjtPageableDto } from "../../../stores/eduProcessCreation/subjectMng/subjectMng.type";
import { format } from "date-fns";
import { FORMAT_YYY_MM_DD } from "../../../constants/screen.const";
import { getListCodeMng } from "../../../stores/common/codeMng/codeMng.service";
import { UP_SUST_DIV_CD } from "../../../constants/common.const";
...
export default {
  ...
  methods: {
    getCodeForm() {
      getListCodeMng({ upCdIdList: [UP_SUST_DIV_CD] }).then((res: any) => {
        this.listSelectBox = res.data.data;
        this.listSelectBox.unshift({ id: 0, cdId: "", cdNm: this.t("common.all") });
      });
    },
    getAllSubject() {
      this.storeCommon.setLoading(true);
      getAllVSbjtInfo(this.dataSearch)
        .then((res: any) => {
