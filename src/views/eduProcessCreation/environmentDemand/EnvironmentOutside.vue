...
export default defineComponent({
  ...
  beforeMount() {
    ...
    this.environDemReqModel.upCdId = UP_CD_EDU_22;
    this.environDemReqModel.upRefrId = UP_CD_EDUT_22;
  ...
  methods: {
    ...
    saveDataEnvDemand() {
      ...
      this.environDemSaveModel.progStepCd = CD_STG023;
