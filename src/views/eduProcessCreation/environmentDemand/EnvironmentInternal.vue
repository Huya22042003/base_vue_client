...
export default defineComponent({
  ...
  beforeMount() {
    ...
    this.environDemReqModel.upCdId = UP_CD_EDU_21;
    this.environDemReqModel.upRefrId = UP_CD_EDUT_21;
  ...
  methods: {
    ...
    saveDataEnvDemand() {
      ...
      this.environDemSaveModel.progStepCd = CD_STG022;
