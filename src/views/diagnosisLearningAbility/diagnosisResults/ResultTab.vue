<template>
  <div class="box_section mt_5">
    <div
      ...
      :key="learnAbilitySeq + dataChart.childAbilitySeq"
    >
      <ul>
        <li>
          <ColumnChart
...
import { DiagResultChartGraphicResModel } from "../../../stores/diagnosislearningAbility/diagLearnAbilityResult/diagLearnAbilityResult.type";
import { commonStore } from "@/stores/common";
import { getCodeMngByUpCdId } from "@/stores/common/codeMng/codeMng.service";
import { CODE_QUESTION, UP_CD_ID_LEVEL_QUS } from "@/constants/common.const";
import { getDataChartGraphicDiagLearnAbility } from "@/stores/diagnosislearningAbility/diagLearnAbilityResult/diagLearnAbilityResult.service";
...
export default defineComponent({
  ...
  methods: {
    ...
    getDataChartGraphic() {
      let request = {
        learnAbilitySeq: this.learnAbilitySeq,
        diagSeq: this.diagSeq,
      };
      getDataChartGraphicDiagLearnAbility(request).then((res: any) => {
