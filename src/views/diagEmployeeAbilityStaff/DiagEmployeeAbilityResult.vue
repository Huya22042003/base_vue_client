      ...
      <div class="box dp_block">
        <div class="box_section">
          <p class="box_title_sm">
            {{ t("11.diagEmployeeAbility.result.title1") }}
          </p>
        ...
        <div class="box_section mt_8">
          <p class="box_title_sm">
            {{ t("11.diagEmployeeAbility.result.title2") }}
          </p>
          <table class="tbl_row tbl_border tbl_result_detail_custom">
            <caption>
              {{
            ...
            <tbody>
              <tr>
                <th scope="row">
                  {{ t("11.diagEmployeeAbility.result.column1") }}
                </th>
                <th scope="row">
                  {{ t("11.diagEmployeeAbility.result.column2") }}
                </th>
                <th scope="row">
                  {{ t("11.diagEmployeeAbility.result.column3") }}
                </th>
                <th scope="row">
                  {{ t("11.diagEmployeeAbility.result.column4") }}
                </th>
              </tr>
              <tr
                v-for="ability1Level in detailInfo.listAbility1level"
                :key="ability1Level.ability1levelSeq"
              >
                <td scope="row">
                  <p>{{ ability1Level.ability1levelNm }}</p>
                </td>
                <td scope="row">
                  <p>{{ ability1Level.category }}</p>
                </td>
                <td scope="row">
                  <p>{{ ability1Level.content }}</p>
                </td>
                <td scope="row">
                  <div
                    v-for="program in ability1Level.listProgram"
...
import { getDetailResult } from "../../stores/diagEmployeeAbilityStaff/diagEmployeeAbility.service";
import { DiagEmpAbilityStaffDetailResultModel } from "../../stores/diagEmployeeAbilityStaff/diagEmployeeAbility.type";
...
export default defineComponent({
  ...
  data() {
    return {
      pageTitle: this.t("11.diagEmployeeAbility.result.pageTitle"),
      breadcrumbItems: [],
      diagSeq: "",
      detailInfo: {} as DiagEmpAbilityStaffDetailResultModel,
    };
  },
  beforeMount() {
