    ...
    <section id="content" class="content_wrapper grid_content" tabindex="0">
      ...
      <div class="divide_box">
        <div class="box box_diag_custom">
          <h3 class="box_title">{{ t("11.diagEmployeeAbility.subTitle1") }}</h3>
          <div
            class="mt_5 mb_8"
            v-for="item in listDiagEmp"
            :key="item.diagSeq"
          >
            <div
        ...
        <div class="box box_diag_custom">
          <h3 class="box_title">{{ t("11.diagEmployeeAbility.subTitle2") }}</h3>
...
import {
  DiagEmpAbilityStaffListModel,
  DiagEmpAbilityStaffResultModel,
} from "../../stores/diagEmployeeAbilityStaff/diagEmployeeAbility.type";
import { getListDataDiagEmpAbility } from "../../stores/diagEmployeeAbilityStaff/diagEmployeeAbility.service";
...
export default defineComponent({
  ...
  data() {
    return {
      pageTitle: this.t("11.diagEmployeeAbility.pageTitle"),
      breadcrumbItems: [],
      listDiagEmp: [] as Array<DiagEmpAbilityStaffListModel>,
      listResult: [] as Array<DiagEmpAbilityStaffResultModel>,
  ...
  methods: {
    loadData() {
      ...
      getListDataDiagEmpAbility().then((res) => {
        this.listDiagEmp = res.data.data.listDiagEmp;
        this.listDiagEmp.forEach((item) => {
