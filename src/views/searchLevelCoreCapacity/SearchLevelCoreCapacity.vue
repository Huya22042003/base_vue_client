        ...
        <div class="box_section">
          <div class="search_box col_3">
            <ul>
              <li>
                <p>
                  {{ t("07.searchLevelCapacity.titleSearch.university") }}
                </p>
                <SelectBoxBase
                  :id="'university'"
                  :name="'university'"
              ...
              <li>
                <p>
                  {{ t("07.searchLevelCapacity.titleSearch.department") }}
                </p>
                <SelectBoxBase
                  :id="'department'"
                  :name="'department'"
              ...
              <li>
                <p>
                  {{ t("07.searchLevelCapacity.titleSearch.status") }}
                </p>
                <SelectBoxBase
                  :id="'status'"
                  :name="'status'"
            ...
            <ul>
              <li>
                <p>
                  {{ t("07.searchLevelCapacity.titleSearch.studyYn") }}
                </p>
                <SelectBoxBase
                  :id="'studyYn'"
                  :name="'studyYn'"
              ...
              <li>
                <p>
                  {{ t("07.searchLevelCapacity.titleSearch.nameStd") }}
                </p>
                <InputBase
                  :id="'nameStd'"
                  :name="'nameStd'"
              ...
              <li>
                <p>
                  {{ t("07.searchLevelCapacity.titleSearch.gender") }}
                </p>
                <SelectBoxBase
                  :id="'gender'"
                  :name="'gender'"
            ...
            <ul>
              <li>
                <p>
                  {{ t("07.searchLevelCapacity.titleSearch.eduYear") }}
                </p>
                <SelectBoxBase
                  :id="'eduYear'"
                  :name="'eduYear'"
...
import {
  getListData,
  getListCore,
} from "@/stores/searchLevelCoreCapacity/searchLevelCoreCapacity.service";
import type {
  SearchModel,
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      pageTitle: this.t("07.searchLevelCapacity.pageTitle"),
      breadcrumbItems: [
        { label: "HOME", link: "/" },
        { label: this.t("07.searchLevelCapacity.breadcrumb"), link: "" },
        { label: this.t("07.searchLevelCapacity.pageTitle"), link: "" },
      ],
      columnDefs: [
        {
          headerName: this.t("07.searchLevelCapacity.table.university"),
          field: "major",
          cellStyle: { textAlign: "center" },
          flex: 1,
        },
        {
          headerName: this.t("07.searchLevelCapacity.table.department"),
          field: "deptNm",
          cellStyle: { textAlign: "center" },
          flex: 1,
        },
        {
          headerName: this.t("07.searchLevelCapacity.table.nameStd"),
          field: "link",
          cellStyle: {
            color: "#2704FF",
            display: "flex",
        ...
        {
          headerName: this.t("07.searchLevelCapacity.table.gender"),
          field: "sexNm",
          cellStyle: { textAlign: "center" },
          flex: 1,
        },
        {
          headerName: this.t("07.searchLevelCapacity.table.eduYear"),
          field: "gradeNm",
          cellStyle: { textAlign: "center" },
          flex: 1,
        },
        {
          headerName: this.t("07.searchLevelCapacity.table.status"),
          field: "shregStsNm",
          cellStyle: { textAlign: "center" },
          flex: 1,
        },
        {
          headerName: this.t("07.searchLevelCapacity.table.studyYn"),
          field: "gradYn",
          cellStyle: { textAlign: "center" },
          flex: 1,
        },
        {
          headerName: this.t("07.searchLevelCapacity.table.number"),
          field: "countAction",
          cellStyle: { textAlign: "center" },
          flex: 1,
        },
      ...
      listSelectBoxDept: [],
      listSelectBoxMajor: [],
      fileNameExport: "SearchLevelCapacity",
      nameOfbtn: this.t("07.searchLevelCapacity.button.downExcel"),
  ...
  methods: {
          ...
          .then((res) => {
            ...
            const rowExcel = this.rowDataAll.map((el) => {
              const colExcel = [
                ...
                el.gradYn,
                ...this.lstTest.map(
                  (element) => el.scores[element.coreAbilitySeq]
                ),
              ];
              return colExcel;
            });
    ...
    async getCoreAbilityName() {
      this.cmn.setLoading(true);
      this.check = false;
      await getListCore().then((res) => {
        this.lstTest = res.data.data;
        res.data.data.forEach((element: any) => {
          this.columnDefs.push({
            headerName: element.coreAbilityNm,
            field: "scores." + element.coreAbilitySeq,
            cellStyle: { textAlign: "center" },
            flex: 1,
          });
        });
