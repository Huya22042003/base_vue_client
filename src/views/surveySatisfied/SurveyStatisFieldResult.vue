          ...
          <table class="tbl_row tbl_border tbl_result_detail_custom">
            ...
            <tbody>
              ...
              <tr>
                <th scope="row">
                  <p>
                    {{ t("07.surveySatisfile.result.quantityTarget") }}
                  </p>
                </th>
                <td colspan="3">
                  <p>
                    <span
                      >{{ detailResult.quantityTarget }}
                      {{ t("07.surveySatisfile.formAdd.people") }}</span
                    >
                  </p>
                </td>
              </tr>
              ...
              <tr>
                <th scope="row">
                  <p>
                    {{ t("07.surveySatisfile.result.quantity") }}
                  </p>
                </th>
                <td colspan="3">
                  <p>
...
import { SurveyInSchoolResultModel } from "../../stores/survey/inSchool/surveyInSchool.type";
import { getResultSurveyInSchool } from "@/stores/survey/inSchool/surveyInSchool.service";
...
import { downloadExcelResultSurveyInSchool } from "@/stores/survey/inSchool/surveyInSchool.service";
...
export default defineComponent({
  ...
  data() {
    return {
      pageTitle: this.t("07.surveySatisfile.result.pageTitle"),
      breadcrumbItems: [],
      modeDetail: MODE_DETAIL,
      id: "",
      detailResult: {} as SurveyInSchoolResultModel,
      dataBaseChart: ref({
        labelsPosition: {
          position: "top",
  ...
  methods: {
    getDetailInfo() {
      ...
      getResultSurveyInSchool({ diagSeq: this.id }).then((res: any) => {
