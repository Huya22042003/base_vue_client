        ...
        <div class="box_section">
          <div class="search_box col_3">
            <ul>
              <li>
                <p>
                  {{ t("07.diagnosingEmployee.diagnosis.titleSearch.name") }}
                </p>
                <InputBase
                  :id="'name'"
                  :name="'name'"
              ...
              <li>
                <p>
                  {{ t("07.diagnosingEmployee.diagnosis.titleSearch.status") }}
                </p>
                <SelectBoxBase
                  :id="'selectbox'"
                  :name="'selectbox'"
              ...
              <li>
                <p>
                  {{ t("07.diagnosingEmployee.diagnosis.titleSearch.date") }}
                </p>
            ...
            <template #button>
              <div class="search_btnarea">
                <button
                  ...
                  @click="register()"
                >
                  {{ t("07.diagnosingEmployee.button.register2") }}
                </button>
              </div>
            </template>
          </GridComponentV2>
...
import { SearchModel } from "../../../stores/diagnosisEmployee/diagnosisEmployees/diagnosisEmployee.type";
import { getAll } from "../../../stores/diagnosisEmployee/diagnosisEmployees/diagnosisEmployee.service";
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      pageTitle: this.t("07.diagnosingEmployee.diagnosis.pageTitle"),
      breadcrumbItems: [],
      columnDefs: [
        {
          headerName: this.t("07.diagnosingEmployee.diagnosis.table.rowNum"),
          field: "rowNumber",
          cellStyle: { textAlign: "center" },
          flex: 0.5,
        },
        {
          headerName: this.t("07.diagnosingEmployee.diagnosis.table.eduYear"),
          field: "diagYearTerm",
          cellStyle: { textAlign: "center" },
          flex: 0.8,
        },
        {
          headerName: this.t("07.diagnosingEmployee.diagnosis.table.name"),
          field: "diagNm",
          cellStyle: {
            color: "#2704FF",
            display: "flex",
        ...
        {
          headerName: this.t(
            "07.diagnosingEmployee.diagnosis.table.diagnosisTime"
          ),
          cellStyle: { textAlign: "center" },
          flex: 1.2,
        ...
        {
          headerName: this.t("07.diagnosingEmployee.diagnosis.table.status"),
          field: "stsCd",
          cellStyle: { textAlign: "center" },
          flex: 0.6,
        },
        {
          headerName: this.t("07.diagnosingEmployee.diagnosis.table.target"),
        ...
        {
          headerName: this.t(
            "07.diagnosingEmployee.diagnosis.table.createdDate"
          ),
          field: "regDate",
          cellStyle: { textAlign: "center" },
          flex: 0.75,
