...
import type { EduCourseDescReqDTO, EduCourseDescSelDTO, EduCourseDetailReqDTO, EduCourseReqModel, EduCourseSearchModel, EduCourseSelRegistDTO } from './eduProcess.type'
