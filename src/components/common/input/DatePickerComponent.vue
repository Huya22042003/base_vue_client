<template>
  <div class="relative" ref="calendarParent" :class="className">
    <input v-if="(mode == modeShow || mode == '') && !isDisable" type="text" :id="id" :name="name" style="width: 100% !important;"
      :placeholder="placeholder" :value="selectedDateText" @click="showCalendar" @input="updateParent"
      @change="changeData" class="datepick" />
    <input v-if="isDisable" type="text" :id="id" :name="name" :value="selectedDateText" @click="showCalendar"
      :placeholder="placeholder" @input="updateParent" @change="updateParent" class="datepick" disabled style="width: 100% !important;"/>
    <input type="text" v-if="mode == modeHidden" :id="id" :name="name" :value="selectedDateText" @click="showCalendar"
      :placeholder="placeholder" @input="updateParent" @change="updateParent" class="datepick" hidden  style="width: 100% !important;"/>
